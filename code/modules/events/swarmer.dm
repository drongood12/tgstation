...
/datum/round_event/spawn_swarmer/announce(fake)
	priority_announce("Наши Сканеры Дальнего Действия обнаружили, что на вашей станции находятся инопланетные паразиты.  Мы предлагаем найти и уничтожить его как можно скорее.", "[command_name()] сообщает")//Сюда не вписать более высокий приоритет никак
