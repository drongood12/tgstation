...
/datum/round_event/brand_intelligence/announce(fake)
	...
	priority_announce("На [station_name()] обнаружена информация о бракованой партии техники \a [source]. Рекомендуется проверка оборудования.", "Предупреждение о бракованной партии")
