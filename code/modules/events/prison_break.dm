...
priority_announce("Зловред ГР3ЙТ4РД проник в шлюзы [station_name()]. Уровень угрозы: [severity]. Рекомендуется вмешательство ИИ.", "Предупреждение системы безопасности")
	else
