...
/datum/round_event/wormholes/announce(fake)
	priority_announce("На станции обнаружены пространственно-временные аномалии. Дополнительных данных нет.", "Предупреждение Об Аномалии", 'sound/ai/spanomalies.ogg')
