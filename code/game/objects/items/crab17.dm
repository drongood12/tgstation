...
/obj/structure/checkoutmachine/Destroy()
	...
	priority_announce("Кредитно-депозитный автомат в [get_area(src)] был уничтожен. Фонды станции перестали истощаться!", sender_override = "Протокол КРАБ-17")
...
/obj/effect/dumpeet_target/proc/startLaunch()
	...
	priority_announce("Пузырь Spacecoin лопнул! Доберитесь до банкомата в [get_area(src)] и снимите со счёта все деньги прежде чем потеряете все свои средства!", sender_override = "Протокол КРАБ-17")
