...
/obj/machinery/computer/communications/ui_act(action, list/params)
	...
	switch (action)
		...
		if ("requestNukeCodes")
			...
			priority_announce("Коды для ядерной боеголовки на станции были запрошены [usr]. Подтверждение или отказ в этом запросе будут отправлены в ближайшее время.", "Запрошены Коды Ядерной Боеголовки", 'sound/ai/commandreport.ogg')
