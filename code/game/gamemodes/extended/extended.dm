...
/datum/game_mode/extended/announced/send_intercept(report = 0)
	priority_announce("Благодаря неустанным усилиям наших подразделений безопасности и разведки в настоящее время нет никаких достоверных угроз для [station_name()]. Все проекты строительства станции были утверждены. Приятной вам смены!", "Отчет Безопасности", 'sound/ai/commandreport.ogg')
