...
/datum/dynamic_ruleset/midround/malf/execute()
	...
	if(prob(ion_announce))
		priority_announce("Ионный шторм обнаружен вблизи станции. Пожалуйста, проверьте все оборудование, управляемое ИИ на наличие ошибок.", "Предупреждение Об Аномалии", 'sound/ai/ionstorm.ogg')
...
/datum/dynamic_ruleset/midround/from_ghosts/space_dragon/generate_ruleset_body(mob/applicant)
	...
	priority_announce("Большой поток органической энергии был зарегистрирован около [station_name()].", "Неопознаная Жизнь")
	return S
