...
/datum/controller/subsystem/nightshift/proc/update_nightshift(active, announce = TRUE)
	...
	if(announce)
		if (active)
			announce("Добрый вечер, команда. Чтобы снизить энергопотребление и стимулировать циркадные ритмы некоторых видов животных, на ночь весь свет на борту станции затемнён.")
		else
